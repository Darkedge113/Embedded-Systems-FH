...
.LC3:
	.string	"\n\rend of eeprom\n\r"
	.text
	.stabs	"send_memory_layout:F(0,47)",36,0,15,send_memory_layout
.global	send_memory_layout
	.type	send_memory_layout, @function
send_memory_layout:
	.stabd	46,0,0
...
.LM6:
	...
	call uart_sendstring
.L3:
	.stabn	68,0,21,.LM7-.LFBB1
.LM7:
	movw r24,r28
	call eeprom_read_byte
	subi r24,lo8(-(48))
	call uart_transmit
	.stabn	68,0,18,.LM8-.LFBB1
.LM8:
	adiw r28,1
	cp r28,__zero_reg__
	ldi r24,1
	cpc r29,r24
	brne .L4
	.stabn	68,0,23,.LM9-.LFBB1
.LM9:
	ldi r24,lo8(.LC3)
	ldi r25,hi8(.LC3)
/* epilogue start */
	.stabn	68,0,24,.LM10-.LFBB1
.LM10:
	pop r29
	pop r28
	.stabn	68,0,23,.LM11-.LFBB1
.LM11:
	jmp uart_sendstring
	.size	send_memory_layout, .-send_memory_layout
	.stabs	"i:r(0,1)",64,0,17,28
...
.Lscope1:
	...
	.stabs	"main:F(0,1)",36,0,26,main
.global	main
	.type	main, @function
main:
	.stabd	46,0,0
	.stabn	68,0,26,.LM12-.LFBB2
.LM12:
.LFBB2:
/* prologue: function */
/* frame size = 0 */
...
.LM15:
	...
	.stabn	68,0,32,.LM16-.LFBB2
.LM16:
	call send_memory_layout
.L8:
