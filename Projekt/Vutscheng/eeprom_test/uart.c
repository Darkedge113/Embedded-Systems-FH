...
uint8_t uart_receive() {
  // this waits for a received character!
  while (! (UCSR0A & (1 << RXC0)));
...
// sends all characters of a string (until the 0 at the end) to the UART
// loop over all characters in the string (until zero at the end)
